...
function removeDetailExcel() {
   [ -f "${RESULT_PATH}/detail_excel.xlsx" ] && { mv  ${RESULT_PATH}/detail_excel.xlsx  ${Tag_Path}_detail_excel.xlsx ; }
}
...
function removeFiles() {
    ...
    [ -f "${RESULT_PATH}/pass_watch_file.txt" ] && { mv  ${RESULT_PATH}/pass_detail_file.txt ${Tag_Path}_pass_detail_file.txt ; }
}
...
function mvnRunTest() {
    ...
    -Dtestautomation.nsapp.language=${Language} test
}
