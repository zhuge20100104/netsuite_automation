 ...
 *  This dropdown list can let you select an item contains String element
 *  For example, if you want to select an element text with "1 Small Company"
 *  You can just use
 *      def dropdownList = new DropdownListExt(context, webDriver, locator)
 *      dropdownList.selectItem('Small Company')
 *
 *  No need to use  "1 Small Company any more"
 */
class DropdownListExt extends AbstractPopupWidget implements ICommonControl {

    private static final Logger log = LoggerFactory.getLogger(DropdownListExt.class);
    ...
    DropdownListExt(GenericWebApp context, WebDriver webDriver, String suiteScriptID) {
    ...
    DropdownListExt(GenericWebApp context, WebDriver webDriver, Locator parentLocator) {
